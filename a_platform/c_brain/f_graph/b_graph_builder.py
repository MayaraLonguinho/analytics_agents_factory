...
from a_platform.c_brain.f_graph.a_graph_backend import ObsidianBackend, GraphifyBackend
...
class GraphBuilder:
    ...
    def __init__(self):
        ...
        base_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "j_runtime", "artifacts")
