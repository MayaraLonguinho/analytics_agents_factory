...
@patch("a_platform.l_quality.a_quality_engine.os.path.exists", return_value=True)
@patch("a_platform.l_quality.a_quality_engine.os.walk")
@patch("a_platform.l_quality.a_quality_engine.Linter")
@patch("a_platform.l_quality.a_quality_engine.SecurityScanner")
