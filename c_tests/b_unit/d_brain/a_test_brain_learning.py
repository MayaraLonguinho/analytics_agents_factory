...
from a_platform.n_learning.a_brain_updater import BrainUpdater
...
@patch("a_platform.c_brain.f_registry.d_knowledge_registry.KnowledgeRegistry")
@patch("a_platform.d_agents.b_architecture.a_architecture_agent.LLMGateway")
